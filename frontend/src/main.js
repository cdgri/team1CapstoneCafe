...
pluralCaseList.push( {plural: "pays", pascal: "Pay"} )

pluralCaseList.push( {plural: "pushMessages", pascal: "PushMessage"} )


pluralCaseList.push( {plural: "orderInfos", pascal: "OrderInfo"} )
